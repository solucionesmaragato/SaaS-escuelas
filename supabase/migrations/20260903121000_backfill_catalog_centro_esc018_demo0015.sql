-- Backfill ID_CENTRO en catálogo TARIFAS / ESPECIALIDADES (solo ESC_018 y DEMO-0015).
-- Idempotente: no toca filas que ya tienen ID_CENTRO; no duplica catálogo.
...
-- Perfil admin Cristina: tenant-wide (sin centro fijo).
