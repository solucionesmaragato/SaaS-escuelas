-- Demo clone: curso ESTADO Activo → FECHA_INICIO hoy (Madrid), FECHA_FIN +2 meses (no copiar rango ESC_018).
...
BEGIN
  ...
  SELECT m.new_id, p_target_cliente, v_target_centro, ce."NOMBRE_CURSO",
         CASE
           WHEN ce."ESTADO" = 'Activo' THEN (timezone('Europe/Madrid', now()))::date
           ELSE ce."FECHA_INICIO"
         END,
         CASE
           WHEN ce."ESTADO" = 'Activo' THEN ((timezone('Europe/Madrid', now()))::date + interval '2 months')::date
           ELSE ce."FECHA_FIN"
         END,
         ce."FESTIVOS", ce."ESTADO"
  FROM public."CURSO_ESCOLAR" ce
  ...
  WHERE hc."ID_CLIENTE" = p_source_cliente AND hc."ID_CENTRO" = p_source_centro;
  ...
  SELECT
    ...
    a."AJUSTE_MANUAL_EUR", a."MOTIVO_AJUSTE", a."METODO_PAGO", a."IBAN", a."TITULAR_CUENTA", a."TLF_BIZUM",
    a."MANDATO", a."TARJETA", a."STRIPE_ID", a."KOREFACTU_ID", a."TOTAL_MENSUAL", a."NOTAS",
