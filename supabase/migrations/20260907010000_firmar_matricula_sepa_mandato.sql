-- firmar_solicitud_matricula: crear MANDATOS_SEPA pendiente al firmar con método SEPA
-- (tg_aviso_mandato_sepa genera el aviso "Mandato SEPA pendiente" en el INSERT).
