...
/**
 * Profesor-only calendar. Do not import from staff routes (/sesiones).
 * Defaults and layout can diverge from CalendarWidget without affecting admin.
 */
export type CalendarEventType = "matriculas" | "leads" | "incidencias";

export interface ProfesorCalendarProps {
  hideFilters?: boolean;
  embedded?: boolean;
...
export function ProfesorCalendar({
  hideFilters = false,
  embedded = false,
  defaultVisibleTypes,
  pageTitle,
